...
- 🏗️ **[Архитектура системы](docs/ARCHITECTURE.md)** - Детальное описание компонентов и принципов работы
- 🔧 **[API Reference](docs/API.md)** - Справочник по интерфейсам и интеграции
